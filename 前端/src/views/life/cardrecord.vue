<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>校园卡充值记录</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索筛选 -->
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="搜索：">
        <el-input size="small" v-model="formInline.cstuId" placeholder="输入充值人学号"></el-input>
      </el-form-item>
      <el-form-item label="">
        <el-input size="small" v-model="formInline.dstuId" placeholder="输入被充值的学号"></el-input>
      </el-form-item>
      <el-form-item label="">
        <el-input size="small" v-model="formInline.number" placeholder="输入充值金额"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="false" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="id" label="编号" width="200">
      </el-table-column>
      <el-table-column sortable prop="cstu_id" label="充值人学号" width="200">
      </el-table-column>
      <el-table-column sortable prop="dstu_id" label="被充值的学号" width="200">
      </el-table-column>
      <el-table-column sortable prop="number" label="充值金额" width="200">
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
...
<script>
import {cardList} from '../../api/life.js' 
